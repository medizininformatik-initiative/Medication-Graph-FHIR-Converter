...
public class Neo4jDatabaseTestExtension implements BeforeAllCallback, BeforeEachCallback, ExtensionContext.Store.CloseableResource {
	...
	public static String getDatabaseFixture() {
		...
		return """
				...
				(:Synonym {name: "Oral"})-[:REFERENCES]->(:EDQM:Code {code: "ISI-0031", name: "Oral", status: "Current", type: "Intended site"})<-[:HAS_CHARACTERISTIC]-(n5)-[:HAS_CHARACTERISTIC]->(:EDQM:Code {code: "BDF-0053", name: "Granules", status: "Current", type: "Basic dose form"})<-[:REFERENCES]-(:Synonym {name: "Granules"}),
