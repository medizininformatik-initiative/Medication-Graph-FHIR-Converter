...
# Script zum Ausführen des Populators mit RxNormDarreichungsformenMappingLoader
# Verwendet DarreichungsformenMapping.csv statt edqm_rxnorm_dose_form_mapping.csv

# Wechsle zum Projekt-Root
SCRIPT_DIR="$( cd "$( dirname "${BASH_SOURCE[0]}" )" && pwd )"
cd "$SCRIPT_DIR/../.."

# Setze Environment Variable für den Loader
export MEDGRAPH_USE_RXNORM_DARREICHUNGSFORMEN_MAPPING=true
...
echo "=== Populator mit RxNormDarreichungsformenMappingLoader ==="
echo "  MMI-Verzeichnis: $MMI_DIR"
echo "  Neo4j Import-Verzeichnis: $NEO4J_IMPORT_DIR"
echo "  Datenbank URI: $DB_URI"
echo "  Benutzer: $DB_USER"
echo "  Mapping-Tabelle: DarreichungsformenMapping.csv"
