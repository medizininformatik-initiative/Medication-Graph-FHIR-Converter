...
/**
 * Creates EDQM standard terms nodes using the edqmObjects.csv file.
 *
...
public class EdqmStandardTermsLoader extends CsvLoader {
	...
	private static final String EDQM_PDF_TYPE = "Pharmaceutical dose form";
	public static final String EDQM_BDF_CLASS = "BDF";
	private static final String EDQM_BDF_TYPE = "Basic dose form";
	public static final String EDQM_ISI_CLASS = "ISI";
	private static final String EDQM_ISI_TYPE = "Intended site";
	public static final String EDQM_RCA_CLASS = "RCA";
	private static final String EDQM_RCA_TYPE = "Release characteristic";
	...
	public EdqmStandardTermsLoader(Session session) {
		super(Path.of("edqmObjects.csv"), session);
	}
