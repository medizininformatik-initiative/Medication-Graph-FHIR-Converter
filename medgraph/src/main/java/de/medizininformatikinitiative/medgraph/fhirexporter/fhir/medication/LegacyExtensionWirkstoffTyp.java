 ...
 */
public class LegacyExtensionWirkstoffTyp implements Extension {
	...
	private LegacyExtensionWirkstoffTyp() {

	}

	public static LegacyExtensionWirkstoffTyp preciseIngredient() {
		return of("PIN");
	}

	public static LegacyExtensionWirkstoffTyp ingredient() {
		return of("IN");
	}

	private static LegacyExtensionWirkstoffTyp of(String value) {
		LegacyExtensionWirkstoffTyp extension = new LegacyExtensionWirkstoffTyp();
	...
	public boolean equals(Object object) {
		...
		LegacyExtensionWirkstoffTyp that = (LegacyExtensionWirkstoffTyp) object;
