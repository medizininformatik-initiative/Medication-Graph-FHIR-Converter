 ...
 * distance exceeds a given threshold. Then, the sum of scores from each token from the search term is divided by the
 * amount of tokens in the search term.
 * <p>
...
public class LevenshteinSetMatcher extends SimpleMatcher<Set<String>, LevenshteinSetMatcher.Match> {
	...
	/**
	 * Creates a new matcher with a Levenshtein distance threshold of 2.
	 */
	public LevenshteinSetMatcher() {
		this(2);
	}
	 ...
	 */
	public LevenshteinSetMatcher(int threshold) {
		this.distance = new LevenshteinDistance(threshold);
	}
	...
	/**
	 * A generated by the {@link LevenshteinSetMatcher}. Can generate a {@link StringSetUsageStatement} stating which
	 * parts of the search term were used in the match as well as edit distance information allowing you to see
	 * which edit distances between which words were considered for the scoring.
	 */
	public static class Match extends de.medizininformatikinitiative.medgraph.searchengine.matcher.model.ScoreBasedMatch<Set<String>>
		...
		/**
		 * The edit distances between the search term tokens and tokens from the identifier which were considered
		 * for the score.
		 */
