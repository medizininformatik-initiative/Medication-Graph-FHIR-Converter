 ...
 */
public class EditDistanceSetMatcher extends SimpleMatcher<Set<String>, EditDistanceSetMatcher.MatchInfo> {
	 ...
	 * which can be taken from these sets. If the score is greater than 0 (i.e. any match is found), a {@link MatchInfo} is
	 * returned, otherwise this function returns null.
	 */
	@Override
	protected @Nullable EditDistanceSetMatcher.MatchInfo match(Set<String> searchTerm, Set<String> target) {
		...
		return new MatchInfo(searchTerm, score, resultDistances);
	}
	...
	/**
	 * Information about a match generated by the {@link EditDistanceSetMatcher}. Can generate a
	 * {@link StringSetUsageStatement} stating which parts of the search term were used in the match as well as edit
	 * distance information allowing you to see which edit distances between which words were considered for the
	 * scoring.
	 */
	public static class MatchInfo extends ScoreMatchInfo implements InputUsageTraceable<StringSetUsageStatement> {
		...
		private MatchInfo(Set<String> searchTerm, double score, List<EditDistance> editDistances) {
			super(score);
