...
public class ApacheLuceneInitialMatchFinder_V3_Speicheroptimierung_ByteBuffer implements InitialMatchFinder<Product>, Closeable {
    private final Session session;
    private final Directory index;


    public ApacheLuceneInitialMatchFinder_V3_Speicheroptimierung_ByteBuffer(Session session) throws IOException {
