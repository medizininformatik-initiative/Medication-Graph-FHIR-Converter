...
public class ApacheLuceneInitialMatchFinder_V3_Speicheroptimierung_MMap implements InitialMatchFinder<Product>, Closeable {
    private final Session session;
    private final Directory index;


    public ApacheLuceneInitialMatchFinder_V3_Speicheroptimierung_MMap(Session session) throws IOException {
        this.session = session;
        this.index = new MMapDirectory(Paths.get("lucene-index"));
        indexProducts();
