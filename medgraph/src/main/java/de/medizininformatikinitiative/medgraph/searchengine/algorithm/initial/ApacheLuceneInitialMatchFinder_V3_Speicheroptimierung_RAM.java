...
public class ApacheLuceneInitialMatchFinder_V3_Speicheroptimierung_RAM implements InitialMatchFinder<Product>, Closeable {
    private final Session session;
    private final Directory index;


    public ApacheLuceneInitialMatchFinder_V3_Speicheroptimierung_RAM(Session session) throws IOException {
