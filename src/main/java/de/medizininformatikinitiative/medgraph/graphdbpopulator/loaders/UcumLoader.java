...
import static de.medizininformatikinitiative.medgraph.graphdbpopulator.DatabaseDefinitions.INGREDIENT_HAS_UNIT_LABEL;
...
public class UcumLoader extends Loader {
	...
	static {
		...
		ucumDefinitions.put("BIO VEKTORGENOM", new UcumDefinition("{Bio. Vectorgenome}", "{BIO. VECTORGENOME}", "Bio. Vectorgenome"));
