...
import de.medizininformatikinitiative.medgraph.matcher.model.Amount;
import de.medizininformatikinitiative.medgraph.matcher.model.Dosage;
...
/**
 * Compares dosage information in a {@link HouselistEntry} against dosage information found in the knowledge graph
	...
	private synchronized Result queryEffectiveDosagesForProductIds(List<Long> mmiIds) {
		return session.run(new Query(
				"MATCH (p:" + DatabaseDefinitions.PRODUCT_LABEL + ")\n" +
						...
						"MATCH (p)--(d:" + DatabaseDefinitions.DRUG_LABEL + ")--(i:" + DatabaseDefinitions.INGREDIENT_LABEL + " {isActive: true})\n" +
						"OPTIONAL MATCH (i)-[:" + DatabaseDefinitions.INGREDIENT_CORRESPONDS_TO_LABEL + "]-(ic:" + DatabaseDefinitions.INGREDIENT_LABEL + ")\n" +
						"OPTIONAL MATCH (d)--(du:" + DatabaseDefinitions.UNIT_LABEL + ")\n" +
