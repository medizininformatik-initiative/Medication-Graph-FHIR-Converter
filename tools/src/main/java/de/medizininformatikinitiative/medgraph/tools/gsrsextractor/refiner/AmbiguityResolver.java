package de.medizininformatikinitiative.medgraph.tools.gsrsextractor.refiner;

import de.medizininformatikinitiative.medgraph.tools.CSVReader;
...
import de.medizininformatikinitiative.medgraph.tools.gsrsextractor.extractor.GsrsExtractor;
...
public class AmbiguityResolver {
	...
	private static final Path OUT_PATH = Path.of("tools", "output", "gsrs_unambiguous.csv");
...
//		}
	...
	protected void execute() throws IOException, InterruptedException {
		try (CSVReader reader = CSVReader.open(GsrsExtractor.OUT_PATH);
		     CSVWriter writer = CSVWriter.open(OUT_PATH)) {
